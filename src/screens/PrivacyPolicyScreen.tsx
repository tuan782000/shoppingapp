  ...
  return (
    <Container back title="Privacy Policy" titlePosition="center">
      <Section>
        ...
        <Space height={20} />
        <TextComponent text="Privacy Policy" color={colors.primary.p500} />
        <Space height={10} />
        <TextComponent
          text="It is a long estabished fact that a reader will be distracted by readable content of a page when looking at its layout. The point of using Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam, provident iusto corrupti dignissimos deleniti maiores quaerat eius reiciendis obcaecati magnam nam sequi cupiditate reprehenderit facilis quas totam neque delectus adipisci. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam, provident iusto corrupti dignissimos deleniti maiores quaerat eius reiciendis obcaecati magnam nam sequi cupiditate reprehenderit facilis quas totam neque delectus adipisci. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam, provident iusto corrupti dignissimos deleniti maiores quaerat eius reiciendis obcaecati magnam nam sequi cupiditate reprehenderit facilis quas totam neque delectus adipisci.
        Quibusdam, provident iusto corrupti dignissimos deleniti maiores quaerat eius reiciendis obcaecati magnam nam sequi cupiditate reprehenderit facilis quas totam neque delectus adipisci. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam, provident iusto corrupti dignissimos deleniti maiores quaerat eius reiciendis obcaecati magnam nam sequi cupiditate reprehenderit facilis quas totam neque delectus adipisci."
        />
      </Section>
    </Container>
  );
